...
export { REGEX_DEFINE_COMPONENT, addCode, addEmits, addProps, getStart, getText, getVolarOptions, isJsxExpression, patchSFC };
export type { PluginContext, VolarContext, VueMacrosPlugin };
